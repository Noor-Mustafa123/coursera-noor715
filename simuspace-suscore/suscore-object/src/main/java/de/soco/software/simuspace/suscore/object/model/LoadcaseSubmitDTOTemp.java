...
/**
 * The Class LoadcaseSubmitDTO is a temp DTO for only lifecycle policy , to map data to it and update entries.
 *
 * @author noman arshad
 */
@JsonIgnoreProperties( ignoreUnknown = true )
public class LoadcaseSubmitDTOTemp implements Serializable {
     ...
     */
    private Object orignalVariantWizardDTO;
     ...
     */
    public Object getOrignalVariantWizardDTO() {
     ...
     */
    public void setOrignalVariantWizardDTO( Object orignalVariantWizardDTO ) {
     ...
     *         the new submit item
     */
    public void setSubmitItem( Object submitItem ) {
