...
import de.soco.software.simuspace.suscore.data.entity.DataObjectReportEntity;
import de.soco.software.simuspace.suscore.data.entity.DocumentEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class DataObjectReportDTO.
 */
public class DataObjectReportDTO extends DataObjectFileDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -691979358085740221L;

    /**
     * The Constant ENTITY_CLASS.
     */
    private static final DataObjectReportEntity ENTITY_CLASS = new DataObjectReportEntity();

    /* (non-Javadoc)
     * @see de.soco.software.simuspace.suscore.object.model.DataObjectDTO#prepareEntity(java.lang.String)
     */
    @Override
    public DataObjectReportEntity prepareEntity( String userId ) {
        DataObjectReportEntity entity = new DataObjectReportEntity();
