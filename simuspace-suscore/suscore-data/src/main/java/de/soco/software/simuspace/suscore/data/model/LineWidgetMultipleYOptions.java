...
/**
 * The type Line widget multiple y options.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class LineWidgetMultipleYOptions extends LineWidgetOptions {

    /**
     * The X axis.
     */
    @UIFormField( name = WIDGET_FIELDS.X_AXIS, title = "3000241x4", type = "select", section = "options", required = true, orderNum = 20 )
    private String x_axis;

    /**
     * The Y axis.
     */
    @UIFormField( name = WIDGET_FIELDS.Y_AXIS, title = "3000242x4", type = "select", section = "options", required = true, orderNum = 21, multiple = true )
