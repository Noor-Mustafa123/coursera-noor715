...
import de.soco.software.simuspace.suscore.data.entity.DataObjectReportSectionEntity;
import de.soco.software.simuspace.suscore.data.entity.DocumentEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class DataObjectReportSectionDTO.
 */
public class DataObjectReportSectionDTO extends DataObjectReportDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -3305451418745750161L;

    /**
     * The Constant ENTITY_CLASS.
     */
    private static final DataObjectReportSectionEntity ENTITY_CLASS = new DataObjectReportSectionEntity();

    /* (non-Javadoc)
     * @see de.soco.software.simuspace.suscore.object.model.DataObjectReportDTO#prepareEntity(java.lang.String)
     */
    @Override
    public DataObjectReportSectionEntity prepareEntity( String userId ) {
        DataObjectReportSectionEntity entity = new DataObjectReportSectionEntity();
