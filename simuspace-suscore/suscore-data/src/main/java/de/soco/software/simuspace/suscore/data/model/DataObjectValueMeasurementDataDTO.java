...
import de.soco.software.simuspace.suscore.data.entity.DataObjectValueMeasurementDataEntity;
import de.soco.software.simuspace.suscore.data.entity.DocumentEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class DataObjectValueMeasurementDataDTO.
 */
public class DataObjectValueMeasurementDataDTO extends DataObjectValueDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -1918229979537827053L;

    /**
     * The Constant ENTITY_CLASS.
     */
    private static final DataObjectValueMeasurementDataEntity ENTITY_CLASS = new DataObjectValueMeasurementDataEntity();

    /* (non-Javadoc)
     * @see de.soco.software.simuspace.suscore.object.model.DataObjectValueDTO#prepareEntity(java.lang.String)
     */
    @Override
    public DataObjectValueMeasurementDataEntity prepareEntity( String userId ) {
        DataObjectValueMeasurementDataEntity entity = new DataObjectValueMeasurementDataEntity();
