...
import de.soco.software.simuspace.suscore.data.entity.AcousticSolverEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class AcousticSolverDTO.
 */
@JsonIgnoreProperties( ignoreUnknown = true )
public class AcousticSolverDTO extends SolverDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = 7370826268652954532L;

    /**
     * The entity class.
     */
    private static final AcousticSolverEntity ENTITY_CLASS = new AcousticSolverEntity();

    /* (non-Javadoc)
     * @see de.soco.software.simuspace.suscore.object.model.SolverDTO#prepareEntity(java.lang.String)
     */
    @Override
    public AcousticSolverEntity prepareEntity( String userId ) {
        AcousticSolverEntity entity = new AcousticSolverEntity();
