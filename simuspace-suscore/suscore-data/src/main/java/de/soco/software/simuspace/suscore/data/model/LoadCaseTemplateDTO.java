...
import de.soco.software.simuspace.suscore.data.entity.LoadCaseTemplateEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class LoadCaseTemplateDTO.
 */
public class LoadCaseTemplateDTO extends SusDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -4250313581003452744L;

    /**
     * The Constant ENTITY_CLASS.
     */
    private static final LoadCaseTemplateEntity ENTITY_CLASS = new LoadCaseTemplateEntity();
     ...
     */
    public LoadCaseTemplateEntity prepareEntity( String userId ) {
        LoadCaseTemplateEntity entity = new LoadCaseTemplateEntity();
     ...
     */
    public LoadCaseTemplateDTO prepareDTO( LoadCaseTemplateEntity entity ) {
        LoadCaseTemplateDTO loadCaseTemplateDTO = new LoadCaseTemplateDTO();
        return loadCaseTemplateDTO;
