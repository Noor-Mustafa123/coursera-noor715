...
import de.soco.software.simuspace.suscore.data.entity.DynamicSolverEntity;
import de.soco.software.simuspace.suscore.data.entity.UserEntity;
import de.soco.software.simuspace.suscore.data.entity.VersionPrimaryKey;

/**
 * The Class DynamicSolverDTO.
 */
public class DynamicSolverDTO extends SolverDTO {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -8752306098757376449L;

    /**
     * The entity class.
     */
    private static final DynamicSolverEntity ENTITY_CLASS = new DynamicSolverEntity();

    /* (non-Javadoc)
     * @see de.soco.software.simuspace.suscore.object.model.SolverDTO#prepareEntity(java.lang.String)
     */
    @Override
    public DynamicSolverEntity prepareEntity( String userId ) {
        DynamicSolverEntity entity = new DynamicSolverEntity();
