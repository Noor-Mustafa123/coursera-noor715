...
public final class MimeTypeConstants {
    ...
    /**
     * Gets the mime value by key.
     *
     * @param strKey
     *         the str key
     *
     * @return the mime value by key
     */
    public static String getMimeValueByKey( String strKey ) {
        String strMimeType = null;

        // get value for particular key
        strMimeType = s_mapMimeTypes.get( strKey );
        if ( ( strMimeType == null ) || ( strMimeType.trim().isEmpty() ) ) {
            strMimeType = null;
        }
    ...
    /**
     * Gets the mime key by value.
     *
     * @param strValue
     *         the str value
     *
     * @return the mime key by value
     */
    public static String getMimeKeyByValue( String strValue ) {
        for ( Map.Entry< String, String > entry : s_mapMimeTypes.entrySet() ) {
            if ( entry.getValue().equalsIgnoreCase( strValue ) ) {
                return entry.getKey();
            }
        }
        return null;
