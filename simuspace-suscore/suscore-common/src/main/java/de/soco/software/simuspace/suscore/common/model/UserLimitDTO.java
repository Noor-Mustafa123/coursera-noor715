...
public class UserLimitDTO implements Serializable {
     ...
     */
    private static final long serialVersionUID = -6302545186810790296L;
     ...
     *         the restricted users
     */
    public UserLimitDTO( int allowedUsers, int restrictedUsers ) {
        super();
    ...
    public boolean equals( Object obj ) {
        ...
        UserLimitDTO other = ( UserLimitDTO ) obj;
    ...
    public String toString() {
        return "UserLimitDTO [allowedUsers=" + allowedUsers + ", restrictedUsers=" + restrictedUsers + "]";
    }
