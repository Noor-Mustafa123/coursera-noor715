...
public class UserDetailEntity implements Serializable {
    ...
    /**
     * language as selected by the user
     */
    @ManyToOne
    @JoinColumn( name = "language_id" )
    private transient LanguageEntity languageEntity;
     ...
     *         the email
     */
    public UserDetailEntity( UUID id, String designation, String contacts, String email, String department, LanguageEntity languageEntity,
            byte[] profilePhoto ) {
        super();
        this.designation = designation;
        this.contacts = contacts;
