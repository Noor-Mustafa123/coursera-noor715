...
public class SuSObjectModel {
     ...
     *         the has life cycle
     */
    public SuSObjectModel( String id, String name, String className, boolean isCustomizable, boolean isCategorizable,
            boolean hasTranslation, boolean isMassdata, String lifeCycle, List< CustomAttributeDTO > customAttributes,
            List< String > contains, List< String > links, boolean hasLifeCycle ) {
        super();
        this.id = id;
        this.name = name;
